<template>
  <div>
    ...
    <div v-else>
      ...
      <h2 class="subtitle">
        Estamos ansiosos para enviar sua primeira caixa!
      </h2>

      <p class="text-center">
        <a href="https://vueschool.io" target="_blank" class="btn">Vá a algum lugar legal!</a>
      </p>
    </div>
    ...
    <div class="loading-wrapper" v-if="asyncState === 'pending'">
      <div class="loader">
        ...
        <p>Aguarde, estamos acessando nossos servidores!</p>
      </div>
    </div>
  </div>
</template>
